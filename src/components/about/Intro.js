  ...
  return (
    <Fragment>
      ...
      <div className="about_text w-full h-auto clear-both float-left border-solid border-[#DFDFDF] border-b pb-[31px] mb-[30px]">
        <p className="mb-[11px]">
          Hi, my name is Muhammad Hassan Ali. I am working as a HTML5 game developer. I’ve spent most of my waking hours for the last three years
          programming games and websites.
        </p>
      </div>
              ...
              <li className="m-0">
                ...
                <span>
                  <a
                    ...
                    href="mha.m.hassan.ali@outlook.com"
                  >
                    mha.m.hassan.ali@outlook.com
                  </a>
                </span>
              </li>
              <li className="m-0">
          ...
          <div className="tokyo_tm_info">
            <ul className="m-0 list-none">
              ...
              <li className="m-0">
                ...
                <span>Foundation for Advancement of Science and Technology (FAST)</span>
              </li>
              <li className="m-0">
                <span className="min-w-[100px] float-left mr-[10px] font-bold text-black">
                  Degree:
      ...
      <div className="tokyo_tm_button" data-position="left">
        <a href="Muhammad_Hassan_Ali.pdf" download>
